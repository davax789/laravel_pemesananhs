            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container mt-4">
                        <form action="{{ route('simpankamar') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <input type="text" id="nama_kamar" name="nama_kamar" class="form-control" placeholder="Nama Kamar" required>
                            </div>
                            <div class="form-group">
                                <input type="text" id="jenis_kamar" name="jenis_kamar" class="form-control" placeholder="Jenis Kamar" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="images">Pilih Gambar Kamar</label>
