        ...
        <div class="table-responsive">
            <table class="table table-striped">
                @if ($detailhistory)
                    <tr>
                        <td>Nama Pemesan</td>
                        <td>{{ $detailhistory->nama_pemesan }}</td>
                    </tr>
                    <tr>
                        <td>Alamat</td>
                        <td>{{ $detailhistory->alamat }}</td>
                    </tr>
                    <tr>
                        <td>No HP</td>
                        <td>{{ $detailhistory->nohp }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Masuk</td>
                        <td>{{ date('d-m-Y', strtotime($detailhistory->tglmasuk)) }}</td>
                    </tr>
                    <tr>
                        <td>Tanggal Keluar</td>
                        <td>{{ date('d-m-Y', strtotime($detailhistory->tglkeluar)) }}</td>
                    </tr>
                    <tr>
                        <td>Total Pembayaran</td>
                        <td>Rp {{ number_format($detailhistory->total_pembayaran, 0, ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td>No Kamar</td>
                        <td>{{ $detailhistory->no_kamar }}</td>
                    </tr>
                    <tr>
                        <td>Admin</td>
                        <td>{{ $detailhistory->admin }}</td>
                    </tr>
                    <tr>
                        <td>Status</td>
                        <td>
                    ...
                    <tr>
                        <td>Date Selesai</td>
                        <td>{{ date('d-m-Y H:i', strtotime($detailhistory->created_at)) }}</td>
                    </tr>
                @else
                    <tr>
            ...
            <a href="/history" class="btn btn-primary"><i class="fa fa-angle-left"></i> Balik</a>
        </div>
    </div>
</div>
    <!-- End of Main Content -->
