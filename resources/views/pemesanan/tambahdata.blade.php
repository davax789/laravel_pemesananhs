            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container mt-4">
                        <form action="{{ route('simpanDt') }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="date" id="tglkeluar" name="tglkeluar" class="form-control" placeholder="Tanggal Keluar">
                            </div>
                            <div class="form-group">
                                <input type="text" id="total_pembayaran" name="total_pembayaran" class="form-control" placeholder="Total Pembayaran">
                            </div>
                            <div class="form-group">
                                <label for="id_kamar">Pilih Kamar:</label>
                                <select id="id_kamar" name="no_kamar" class="form-control" required>
                            ...
                            <div class="form-group">
                                <input type="text" id="admin" name="admin" class="form-control" placeholder="Nama Admin">
                            </div>
