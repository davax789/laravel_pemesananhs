...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <!-- Begin Page Content -->
        <div class="container-fluid"><h3>Dashboard</h3>
<br/>
<div class="row">
    <!--STATUS cardS -->
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-upload"></i>  Pesanan Sekarang</h6>
            </div>
            <div class="card-body">
                <center>
                    <h1>{{ $totalPesanan }}</h1>
            ...
            <div class="card-footer">
                <a href='/datapemesanan'>------<i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h6 class="pt-2"><i class="fas fa-chart-bar"></i> Total Pesanan Selesai
                </h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='/history'>------<i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    <!-- STATUS cardS -->
